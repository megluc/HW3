...
import java.lang.Math;
    ...
    // Make tree empty
        ...
        private Node deleteElement(int value, Node node) {
            if(node == null) { // base case if the node is null, return null
                return null;
            }

            // First, Do standard BST deletion
            ...
            } else { //node to be deleted if found

                if((node.leftChild == null) || (node.rightChild == null)){ //node with only one child or none
                      Node temp = null;
         ...
         *       zl  zr                     zr   zl  yr  xr
         *
         *  @paramX - node that is out of balance
         *
